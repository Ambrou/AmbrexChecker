...
Scénario: Configuration réussi du plugin
  Soit une ligne de commande avec 2 arguments
  ...
  Alors le fichier contenant les exigences amonts est fichier 'fichier amont.txt'
    Et le fichier contenant les exigences avals est fichier 'fichier aval.doc'
